...
const about = {
  title: "About Me",
  description:
    "I'm a passionate full-stack developer with 6+ years of experience building innovative and scalable web applications. I am proficient in both frontend and backend technologies and am always eager to learn more.",
  info: [
